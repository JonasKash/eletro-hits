...
const VIDEOS: Video[] = [
  ...
  {
    titulo: "Corona - The Rhythm of the Night",
    duracao: "1:48",
    likes: 2310,
    dislikes: 88,
    canal: "Hits2010Mix",
    visualizacoes: "210,670",
    categoria: "Retrô Dance",
    cor: "linear-gradient(135deg,#A3E635,#22D3EE)",
    previa: "/audio/previa-09.mp3",
  },
  {
    titulo: "Calvin Harris feat. Ne-Yo - Let's Go",
    duracao: "2:50",
    likes: 1876,
    dislikes: 95,
    canal: "Hits2010Mix",
    visualizacoes: "145,900",
    categoria: "Trance Pop",
    cor: "linear-gradient(135deg,#0EA5E9,#10B981)",
    previa: "/audio/previa-10.mp3",
  },
  {
