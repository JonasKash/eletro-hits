...
// Mesma chave/conta usada nos projetos avestra-tag-nfc e euacheiapromocao (mesmo CNPJ, confirmado pelo titular da conta).

const PIX_KEY = "66309977000101"; // CNPJ, somente dígitos
const MERCHANT_NAME = "AVESTRA TAG NFC"; // máx. 25 caracteres, sem acento — nome registrado na conta
